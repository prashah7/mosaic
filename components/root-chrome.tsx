...
const bareRoutes = ["/welcome", "/signup", "/login", "/onboarding"];
        ...
        <div className="min-h-screen bg-background text-foreground">
          <header className="border-b border-border/80">
            <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4 sm:px-6">
              <Link
                href="/welcome"
                className="text-[22px] font-semibold tracking-[-0.03em] text-foreground transition hover:opacity-90 focus-ring rounded-md"
              >
                Mosaic
